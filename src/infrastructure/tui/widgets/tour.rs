...
pub const TOUR_STEPS: &[TourStep] = &[
    ...
    TourStep {
        title: "Teams & Agents",
        body: &[
            "clash manages Claude Code Agent Teams — groups of Claude instances collaborating on tasks.",
            "Open a team (Enter) to see its members and tasks; a ● dot marks members whose session is currently running.",
        ],
        keys: &[
            (":teams", "Teams view"),
            ("Enter", "Open team → members; again → agent detail"),
            ("t", "View the team's tasks (from team detail)"),
            ("c", "Create team (Teams) / task (Tasks)"),
            ("R", "Rename the selected team"),
            ("d", "Delete team (Teams) / task (Tasks)"),
            ("e / m / x", "Edit description / add / remove member"),
            ("s / a", "Cycle task status / assign owner (Tasks)"),
            (":member type|prompt|rename|model", "Edit an agent"),
        ],
    },
    TourStep {
        title: "Scratches",
        ...
        keys: &[
            ...
            ("a / c / n", "New note (in the selected folder)"),
            ("A", "New folder"),
    ...
    TourStep {
        ...
        keys: &[
            ...
            (
                ":active / :all / :external",
                "Filter sessions (active / all / wild + external only)",
            ),
