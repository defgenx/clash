...
pub const TOUR_STEPS: &[TourStep] = &[
    ...
    TourStep {
        ...
        body: &[
            "Press  a  to attach to any session. This opens a live terminal inside clash — you can see Claude's output and type responses.",
            "",
            "While attached:",
        ],
        keys: &[
            ("Esc", "Detach (session keeps running)"),
            ("Ctrl+B", "Detach (alternative)"),
        ],
    },
    TourStep {
    ...
    TourStep {
        title: "Expanding Subagents",
        body: &[
            "Sessions that spawn subagents show a  count  in the AGENTS column.",
            "",
            "Press  Tab  to expand a session row and see its subagents inline. Press  Tab  again to collapse.",
            "",
            "The AGENTS column shows a compact status summary:",
        ],
        keys: &[
            ("3 (1! 2\u{25ce})", "3 agents: 1 prompting, 2 thinking"),
            ("\u{25b6}", "Collapsed (has subagents)"),
            ("\u{25bc}", "Expanded"),
        ],
    },
    TourStep {
    ...
    TourStep {
        ...
        body: &[
            ...
            "  Attach to interact with Claude live",
