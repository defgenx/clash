...
pub fn render_help_overlay(
    ...
    for &(cmd, desc) in &[
        ...
        (":rename team X Y", "Rename team X to Y"),
        (":delete team X", "Delete team"),
        (":member model X Y", "Set member model (team views)"),
        (":member type X Y", "Set member agent type"),
        (":member prompt X …", "Set member system prompt"),
        (":member rename X Y", "Rename member X to Y"),
        (":create task T S", "Create task (team + subject)"),
